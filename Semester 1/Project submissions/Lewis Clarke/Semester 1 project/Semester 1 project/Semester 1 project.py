...
class Bank_account(object):
    ...
    def account_create(self):
        while True:
            ...
            userid2 = raw_input('Please comfirm your user id: ')
            passid = raw_input('Please create a password\nThis will be your password to login:  ')
            passid2 = raw_input('Please confirm your password:  ')
            if userid == userid2 and passid == passid2:
...
class Overdraft(Bank_account):
    # Adds the overdraw option to the main bank account class 
    def __init__ (self):
...
def main_screen_o(): # Prints out the main banking screen the the overdraft
...
def opening_o(): # Opens login page with over draft
...
def main_screen(): #Prints main screen with standard bank account 
...
def opening(): # Prints the first login page
